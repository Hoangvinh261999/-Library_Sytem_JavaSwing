 ...
 * @author huydo
 */
public class sachPanelUi extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnAdd.setBackground(new java.awt.Color(254, 231, 197));
        ...
        btnThungRac.setBackground(new java.awt.Color(254, 231, 197));
        btnThungRac.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(btnThungRac, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(btnThungRac, javax.swing.GroupLayout.DEFAULT_SIZE, 36, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        // TODO add your handling code here:
        if (validateForm()) {
            if (sachDAO.findbyMa(txtMaSach.getText()) != null) {
                JOptionPane.showMessageDialog(this, "Sach da ton tai");
                return;
            }
            try {
                Sach sach = getModelAdd();
    ...
    private void btnDelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDelActionPerformed
        ...
        if (sachDAO.findbyMa(txtMaSach.getText()) == null) {
            ...
            int result = JOptionPane.showConfirmDialog(this,
                    ...
                    JOptionPane.QUESTION_MESSAGE);
            if (result == JOptionPane.YES_OPTION) {
                if (sachDAO.del(txtMaSach.getText()) > 0) {
    ...
    private void btnThungRacActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThungRacActionPerformed
        // TODO add your handling code here:
        JPanel jp = new thungRacSachPanelUi();
        dialog.add(jp);
    ...
    public boolean validateForm() {
        if (txtTenSach.getText().isBlank() && txtNhaXB.getText().isBlank() && txtTacGia.getText().isBlank()
