 ...
 * @author kuteb
 */
public class DoiMatKhauCaNhanUi extends javax.swing.JPanel {
...
//        getTT();
    ...
    private void initComponents() {
        ...
        txtThoiGian.setText("Mã xác nhận có hiệu lực trong 1 phút");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(26, 26, 26)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtMKCu, javax.swing.GroupLayout.DEFAULT_SIZE, 323, Short.MAX_VALUE)
        ...
        jLabel7.setText("Đổi mật khẩu cá nhân");
            ...
            if (checkMKCu()) {
                try {
                    ...
                    if (result == JOptionPane.YES_OPTION) {
                        ...
                        if (updateMKbyMaTK(maTk) > 0 || updateMKbyMail(gmail) > 0) {
    ...
    private void showPasswordCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showPasswordCheckBoxActionPerformed
        ...
        if (showPasswordCheckBox.isSelected()) {
            txtMKCu.setEchoChar((char) 0); // Hiển thị mật khẩu
            txtMKmoi.setEchoChar((char) 0);
            txtNhapLaiMK.setEchoChar((char) 0);
        } else {
            txtMKCu.setEchoChar('\u25cf'); // Ẩn mật khẩu
...
// dao
    ...
    public String getMKCubyMATK(String maTK) {
        try {
            String sql = "select password from TaiKhoan where MaTK = ?";
            conn = layKetNoi();
    ...
    public String getMKCubyMail(String mail) {
        try {
            String sql = "select password from TaiKhoan tk inner join NguoiDung nd on tk.MaTK = nd.MaTK where nd.email = ?";
            conn = layKetNoi();
            sttm = conn.prepareStatement(sql);
            sttm.setString(1, mail);
            ResultSet rs = sttm.executeQuery();
            while (rs.next()) {
                return rs.getString(1);
            }
    ...
    public String getEmailbyMATK(String maTK) {
        try {
            String sql = "select email from NguoiDung where MaTK = ?";
            conn = layKetNoi();
            sttm = conn.prepareStatement(sql);
            sttm.setString(1, maTK);
            ResultSet rs = sttm.executeQuery();
    ...
    public int updateMKbyMaTK(String maTK) {
        try {
            String sql = "update TaiKhoan set password = ? where MaTK = ?";
            conn = layKetNoi();
            sttm = conn.prepareStatement(sql);
            sttm.setString(1, txtMKmoi.getText());
            sttm.setString(2, maTK);
       ...
       private void startNumberThread() {
        numberThread = new Thread(() -> {
            ...
            while (!Thread.interrupted()) {
                ...
                try {
                    Thread.sleep(120000); // Sleep for 1 minute
...
//   validate
    ...
    public boolean validateForm() {
        ...
        if (passCu.isBlank() && passMoi.isBlank() && passNhapLai.isBlank()) {
            JOptionPane.showMessageDialog(this, "Chưa nhập thông tin !");
            return false;
        }

        if (passCu.trim().equals("")) {
            JOptionPane.showMessageDialog(this, "Chưa nhập password cũ !");
